           ...
           carrito.forEach((producto) => {
                 document.getElementById("cards-modal").innerHTML += `
                    <tr>
                       ...
                       <td> <button class="btn btn-danger" id="botonEliminar${producto.id}">X</button></td>
                    <br>
                    </tr>
                `
            })
...
/* 
    carrito.forEach((productos)=>{
        ...
        let productoCompra = document.getElementById("${producto.id}")
        console.log(productoCompra);
        productoCompra.remove()
        })
    }) */
    ...
    carrito.forEach((producto, indice) => {
        ...
        document.getElementById(`botonEliminar${producto.id}`).addEventListener('click',()=>{
            alert("apretaste")       
            /* console.log(`Producto ${producto.titulo} eliminado`)
         let cardProducto = document.getElementById(`${producto.id}`)   
